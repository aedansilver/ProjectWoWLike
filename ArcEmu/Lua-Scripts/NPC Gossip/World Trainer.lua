...
class = player:GetPlayerClass()
		pUnit:GossipCreateMenu(100001, player, 0)
if (player:GetPlayerClass() == "Warrior") then -- warrior
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",5,0)
elseif (player:GetPlayerClass() == "Paladin") then -- paladin
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",6,0)
elseif (player:GetPlayerClass() == "Rogue") then -- rogue
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",7,0)
elseif (player:GetPlayerClass() == "Hunter") then -- hunter
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",8,0)
elseif (player:GetPlayerClass() == "Druid") then -- hunter
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",14,0)
elseif (player:GetPlayerClass() == "Priest") then -- priest
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",9,0)
elseif (player:GetPlayerClass() == "Mage") then -- mage
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",10,0)
elseif (player:GetPlayerClass() == "Warlock") then -- warlock
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",11,0)
elseif (player:GetPlayerClass() == "Shaman") then -- shaman
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",12,0)
elseif (player:GetPlayerClass() == "Death Knight") then -- dk
		pUnit:GossipMenuAddItem(3,"Train me, "..class.." spells.",13,0)
end
		pUnit:GossipMenuAddItem(9,"Learn skill, weapon train.",1,0)
		pUnit:GossipMenuAddItem(6,"Learn mount skill.", 2000, 0)
		pUnit:GossipMenuAddItem(2,"Advance skill lines.",4,0)
		pUnit:GossipMenuAddItem(4,"Reset Talent Points",2,0)
...
if (player:GetPlayerClass() == "Death Knight") then
	player:AddSkill(433, 1000, 1000)
end
	end

	if (intid == 2) then
		pUnit:GossipCreateMenu(100001, player, 0)
		pUnit:GossipMenuAddItem(0,"I understand, continue.",3,0)
		pUnit:GossipSendMenu(player)
end
...
player:GossipMiscAction(9, player, 1)
	...
	if (intid == 4) then
	-- pUnit:SendChatMessageToPlayer(41, 0, "All of your weapon skills are now up to date.", player)
-- player:GossipComplete()
	player:AdvanceSkill(43, 1000)
	player:AdvanceSkill(55, 1000)
	player:AdvanceSkill(173, 1000)
	...
	player:AdvanceSkill(162, 1000)
	pUnit:GossipCreateMenu(100001, player, 0)
		pUnit:GossipMenuAddItem(0,"Success!",75,0)
		pUnit:GossipSendMenu(player)
	end
...
-- class train
	...
	if (intid == 5) then
	-- pUnit:SendChatMessageToPlayer(41, 0, "You have Learned all your class spells.", player)
-- player:GossipComplete()
			pUnit:GossipCreateMenu(100001, player, 0)
				pUnit:GossipMenuAddItem(0,"Success! Spell learnt.",75,0)
				pUnit:GossipSendMenu(player)
...
if(intid == 75) then
return Class_OnGossip(pUnit, event, player)
end
