...
local npcnamefunc1 = "Capricorn1"
local npcnamefunc2 = "Capricorn2"
local npcnamefunc3 = "Capricorn3"

local npcspellname1 = "capri1"
local npcspellname2 = "capri2"
local npcspellname3 = "capri3"
local npcspellname4 = "capri4"

function npcnamefunc1(pUnit, Event, pPlayer)
pUnit:CastSpellOnTarget(48657, pPlayer)
